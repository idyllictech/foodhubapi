...
const mgg = require('nodemailer-mailgun-transport');
...
const DOMAIN = 'sandbox2e3c33aa72a348a3a2db72325bf6551b.mailgun.org';
...
const mailgunAuth = {
  ...
  const smtpTransport = nodemailer.createTransport(mgg(mailgunAuth))
...
const addTalenter = async (req, res) => {
    ...
    pool.query(queries.checkEmailExists, [email], (error, results) => {
        ...
        pool.query(queries.addTalenter,
            ...
            //      html: `
            //      <html><body><h2>Please click on given link to activate the account</h2>
            //         <p>Please click this email to activate your email: <a> href="${url}"${url}</a></p></body></html>
            //         `
            //     };
